...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private void updateloc() {
        ...
        MarkerOptions marker = new MarkerOptions().position(new LatLng(latitude, longitude)).draggable(true).title(getString(R.string.set_location));
        marker.icon(icon);
        ...
        //Toast.makeText(MapActivity.this, "Your location has been updated", Toast.LENGTH_SHORT).show();
