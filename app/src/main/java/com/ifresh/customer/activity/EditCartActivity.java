...
import com.ifresh.customer.adapter.EditCartListAdapter_2;
...
public class EditCartActivity extends AppCompatActivity {
    ...
    public StorePrefrence storePrefrence;
    Session session;
    DatabaseHelper databaseHelper;
    Activity activity;
    Context mContext = EditCartActivity.this;
    ...
    private Menu menu;
    EditCartListAdapter_2 editCartListAdapter_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.editcart));
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        session = new Session(EditCartActivity.this);
        storePrefrence = new StorePrefrence(EditCartActivity.this);
        builder = new AlertDialog.Builder(EditCartActivity.this);
        ...
        cartrecycleview.setLayoutManager(new LinearLayoutManager(EditCartActivity.this));
        databaseHelper = new DatabaseHelper(EditCartActivity.this);
        activity = EditCartActivity.this;
            ...
            public void onClick(View v) {
                if (session.isUserLoggedIn()) {
                    ...
                    if (last_subtotal < Constant.SETTING_MINIMUM_AMOUNT_FOR_FREE_DELIVERY) {
                        ...
                        startActivity(new Intent(EditCartActivity.this, CheckoutActivity_Edit.class)
                        );
                    }
                } else {
                    startActivity(new Intent(EditCartActivity.this, SignUpActivity_K.class).putExtra("fromto", "signup"));
                }
            }
        });
    ...
    private void showAlertView(String disp_total) {
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(EditCartActivity.this);
        ...
        tvchkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                startActivity(new Intent(EditCartActivity.this, CheckoutActivity_2.class));
            }
        });
    ...
    public void SetDataTotal() {
        ...
        double total = databaseHelper.getTotalCartAmt_edit(session,storePrefrence.getString("order_id"));

        String displaytotal = DatabaseHelper.decimalformatData.format(total);
        if (editCartListAdapter_2.getItemCount() == 1) {
            txttotal.setText(activity.getResources().getString(R.string.total_) + editCartListAdapter_2.getItemCount() + activity.getResources().getString(R.string._item_) + Constant.SETTING_CURRENCY_SYMBOL + " " + displaytotal);
        } else
            txttotal.setText(activity.getResources().getString(R.string.total_) + editCartListAdapter_2.getItemCount() + activity.getResources().getString(R.string._items_) + Constant.SETTING_CURRENCY_SYMBOL + " " + displaytotal);
        ...
        if (total <= Constant.SETTING_MINIMUM_AMOUNT_FOR_FREE_DELIVERY) {
            ...
            txtdeliverycharge.setTextColor(activity.getResources().getColor(R.color.quantum_grey900));
    ...
    public Double SetDataTotal_2() {
        ...
        total = databaseHelper.getTotalCartAmt_edit(session,storePrefrence.getString("order_id"));
        double subtotal = total;
        return subtotal;
    }
    ...
    public void minimum_order() {
        Double last_subtotal = SetDataTotal_2();
        if (ISACCEPTMINORDER) {
            relative.setBackgroundResource(R.drawable.bg_button_quantmgray);
    ...
    private void getData() {
        ...
        Log.d("order-id", storePrefrence.getString("order_id"));

        idslist = databaseHelper.getCartList_edit(storePrefrence.getString("order_id"));
        ...
        if (idslist.isEmpty()) {
            ...
            for (final String id : idslist) {
                        ...
                        if (result) {
                            try {
                                ...
                                if (objectbject.getInt(Constant.SUCESS) == 200) {
                                    ...
                                    ModelProduct product = ApiConfig.GetEditCart(jsonArray_products, ids[1], ids[4], databaseHelper, measurement_list, storePrefrence);
                                    ...
                                    if (finalI == idslist.size()) {
                                        ...
                                        editCartListAdapter_2 = new EditCartListAdapter_2(productArrayList, EditCartActivity.this,storePrefrence.getString("order_id"));
                                        cartrecycleview.setAdapter(editCartListAdapter_2);
                                        progressbar.setVisibility(View.GONE);
                ...
                }, EditCartActivity.this, get_param, params, false);
                i++;
            }
        }
    }
    ...
    public void onResume() {
        ...
        if (databaseHelper.getTotalItemOfCart_edit( storePrefrence.getString("order_id")) == 0)
        {
            lytempty.setVisibility(View.VISIBLE);
            lyttotal.setVisibility(View.GONE);
            ...
            {
                productArrayList = new ArrayList<>();
                cartrecycleview.setAdapter(new EditCartListAdapter_2(productArrayList, EditCartActivity.this, storePrefrence.getString("order_id")));
            }
        }
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.menu_edit_cart).setVisible(false);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_sort:
                if (productArrayList != null && productArrayList.size() > 0) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditCartActivity.this);
                    builder.setTitle(EditCartActivity.this.getResources().getString(R.string.filterby));
                                ...
                                case 0:
                                    ...
                                    handler.postDelayed(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            progressbar.setVisibility(View.GONE);
                                            editCartListAdapter_2.notifyDataSetChanged();
                                        }
                                    }, 2000);
                                    break;
                                case 1:
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(EditCartActivity.this, MainActivity.class);
    ...
    private void callSettingApi_messurment() {
        ...
        //check if order is cancel prior or not
        cancel_order_status();
    ...
    private void cancel_order_status() {
        ...
        }, EditCartActivity.this, Constant.BASEPATH  + GET_ORDERCONFORMATION + storePrefrence.getString("order_id") + "/" + session.getData(Session.KEY_id)  , params, false);
